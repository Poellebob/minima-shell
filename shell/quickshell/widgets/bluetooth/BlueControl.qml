    ...
    ColumnLayout {
      ...
      RowLayout {
        ...
        StyledButton {
          ...
          visible: root.currentAdapter?.enabled ?? false
          text: root.currentAdapter?.discovering ? "󰑎  Scanning…" : "󰐷  Scan"
          colorDefault: root.currentAdapter?.discovering
            ? Global.colors.primary_container
            : Global.colors.surface_container
          colorHovered: root.currentAdapter?.discovering
            ? Global.colors.primary_container
            : Global.colors.surface_container_high
          colorText: root.currentAdapter?.discovering
        ...
        Toggle {
          checked: root.currentAdapter?.enabled ?? false
          onToggled: {
            if (root.currentAdapter)
      ...
      Rectangle {
        ...
        StyledText {
          ...
          text: {
            ...
            if (!root.currentAdapter.enabled) return "Bluetooth is off"
        ...
        ListView {
          ...
          model: root.currentAdapter?.devices ?? []
