                            ...
                            MouseArea {
                                ...
                                RowLayout {
                                    ...
                                    StyledText {
                                        ...
                                        color: inputMouseArea.containsMouse ? Global.colors.on_surface : isDefault ? Global.colors.primary : Global.colors.on_surface_variant
                            ...
                            MouseArea {
                                ...
                                RowLayout {
                                    ...
                                    StyledText {
                                        ...
                                        color: outputMouseArea.containsMouse ? Global.colors.on_surface : isDefault ? Global.colors.primary : Global.colors.on_surface_variant
                                        elide: Text.ElideRight
                                    }
            ...
            RowLayout {
                ...
                Repeater {
                    ...
                    delegate: Item {
                        ...
                        implicitWidth: playerText.implicitWidth + Global.format.spacing_small * 2
                        Layout.fillHeight: true
                        ...
                        MouseArea {
                            ...
                            StyledText {
                                ...
                                color: parent.containsMouse ? Global.colors.on_surface : isActive ? Global.colors.primary : Global.colors.on_surface_variant
                                elide: Text.ElideRight
                            }
                        }
                    }
