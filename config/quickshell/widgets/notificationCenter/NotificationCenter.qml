      ...
      ColumnLayout {
        ...
        RowLayout {
          ...
          Text {
            ...
            text: notifServer.trackedNotifications.count + " unread"
            font.family: "JetBrainsMono Nerd Font"
          ...
          Button {
            ...
            implicitWidth: clearLabel.implicitWidth + Global.format.spacing_large

            onClicked: {
              for (let i = notifServer.trackedNotifications.count - 1; i >= 0; i--) {
                notifServer.trackedNotifications.get(i).close()
              }
            }
            ...
            background: Rectangle {
              color: parent.pressed
                ? Global.colors.error
                : (parent.hovered ? Global.colors.error_container : Global.colors.surface)
