...
MenuPanel {
  ...
  property var notifServer: notifServer
      ...
      ColumnLayout {
        ...
        RowLayout {
          ...
          Text {
            ...
            text: notifServer.notifications.length + " unread"
            font.family: "JetBrainsMono Nerd Font"
          ...
          StyledButton {
            ...
            onClicked: {
              for (let i = notifServer.notifications.length - 1; i >= 0; i--) {
                notifServer.notifications[i].close()
              }
            }
        ...
        Rectangle {
          ...
          ListView {
            ...
            model: {
              let arr = notifServer.notifications.values.slice()
              arr.reverse()
              return arr
            }
